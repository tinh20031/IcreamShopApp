            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    ...
                    if (user != null) {
                        ...
                        // Đảm bảo bạn đang lưu thông tin người dùng vào SharedPreferences sau khi đăng nhập thành công
                            ...
                            public void onResponse(Call<User> call, Response<User> response) {
                                if (response.isSuccessful()) {
                                    ...
                                    if (detailedUser != null) {
                                        ...
                                        editor.putString("passwordHash",detailedUser.getPasswordHash() != null ? detailedUser.getPasswordHash():"Không xác định");
